...
/**
 * Base class that all CMF modules should extend.
 */
abstract class Module extends Runtime\Freezable implements IModule
{
   ...
   /**
     ...
     *
     * @throws CMF\Core\Runtime\Moule\InvalidFieldException
     */
     ...
     *
     * @throws CMF\Core\Runtime\InvalidImplementorException
     */
    ...
    /**
     * Constructs a new CMF\Core\Runtime\Module\Module.
     *
     * @param string $name
     * @param array $fields
     */
