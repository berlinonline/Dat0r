...
class AggregateField extends Field
{
     ...
     *
     * @return CMF\Core\Runtime\Module\AggregateModule
     */
    ...
    {
        return 'CMF\Core\Runtime\ValueHolder\AggregateValueHolder';
    }
    ...
    {
        return 'CMF\Core\Runtime\Validator\AggregateValidator';
    }
}
