...
class IntegerFieldTest extends Runtime\BaseTest
{
    ...
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('CMF\Core\Runtime\Field\IntegerField', $integerField);
    }
    ...
    public function testCreateValueHolder($intValue)
    {
        ...
        $this->assertInstanceOf('CMF\Core\Runtime\ValueHolder\IntegerValueHolder', $valueHolder);
