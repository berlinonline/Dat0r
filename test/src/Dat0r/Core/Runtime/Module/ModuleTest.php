...
class ModuleTest extends BaseTest
{
    ...
    public function testGetFieldsMethodPlain(IModule $module)
    {
        ...
        $this->assertInstanceOf('Dat0r\\Core\\Runtime\\Field\\TextField', $fields->get('email'));
        $this->assertInstanceOf('Dat0r\\Core\\Runtime\\Field\\TextCollectionField', $fields->get('keywords'));
        ...
        $this->assertInstanceOf('Dat0r\\Core\\Runtime\\Field\\ReferenceField', $fields->get('references'));
    }
