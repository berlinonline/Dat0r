...
class ImageAttribute extends Attribute
{
    ...
    const OPTION_STORAGE_LOCATION_ALLOW_CRLF                 = ImageRule::OPTION_STORAGE_LOCATION_ALLOW_CRLF;
    const OPTION_STORAGE_LOCATION_ALLOW_TAB                  = ImageRule::OPTION_STORAGE_LOCATION_ALLOW_TAB;
    const OPTION_STORAGE_LOCATION_MAX_LENGTH                 = ImageRule::OPTION_STORAGE_LOCATION_MAX_LENGTH;
    const OPTION_STORAGE_LOCATION_MIN_LENGTH                 = ImageRule::OPTION_STORAGE_LOCATION_MIN_LENGTH;
    const OPTION_STORAGE_LOCATION_NORMALIZE_NEWLINES         = ImageRule::OPTION_STORAGE_LOCATION_NORMALIZE_NEWLINES;
    const OPTION_STORAGE_LOCATION_REJECT_INVALID_UTF8        = ImageRule::OPTION_STORAGE_LOCATION_REJECT_INVALID_UTF8;
    const OPTION_STORAGE_LOCATION_STRIP_CONTROL_CHARACTERS  =
        ImageRule::OPTION_STORAGE_LOCATION_STRIP_CONTROL_CHARACTERS;
    const OPTION_STORAGE_LOCATION_STRIP_DIRECTION_OVERRIDES =
        ImageRule::OPTION_STORAGE_LOCATION_STRIP_DIRECTION_OVERRIDES;
    const OPTION_STORAGE_LOCATION_STRIP_INVALID_UTF8         = ImageRule::OPTION_STORAGE_LOCATION_STRIP_INVALID_UTF8;
    const OPTION_STORAGE_LOCATION_STRIP_NULL_BYTES           = ImageRule::OPTION_STORAGE_LOCATION_STRIP_NULL_BYTES;
    const OPTION_STORAGE_LOCATION_STRIP_ZERO_WIDTH_SPACE    =
        ImageRule::OPTION_STORAGE_LOCATION_STRIP_ZERO_WIDTH_SPACE;
    const OPTION_STORAGE_LOCATION_TRIM                       = ImageRule::OPTION_STORAGE_LOCATION_TRIM;
