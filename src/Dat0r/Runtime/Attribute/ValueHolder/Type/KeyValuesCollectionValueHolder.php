...
namespace Dat0r\Runtime\Attribute\ValueHolder\Type;

use Dat0r\Runtime\Attribute\ValueHolder\ValueHolder;
use Dat0r\Common\Error\BadValueException;
use Dat0r\Runtime\Attribute\IAttribute;
use Dat0r\Runtime\Attribute\Type\KeyValuesCollection;
...
class KeyValuesCollectionValueHolder extends ValueHolder
{
    ...
    {
        $constraints = $this->getAttribute()->getOption(KeyValuesCollection::OPT_VALUE_CONSTRAINT, array());
        $value_type = 'dynamic';
